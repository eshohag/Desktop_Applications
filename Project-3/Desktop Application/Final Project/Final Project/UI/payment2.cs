...
namespace Final_Project
{
    public partial class payment2 : Form
    {
        ...
        {
            if ((String.IsNullOrEmpty(txt_patientId2.Text)) || (string.IsNullOrEmpty(txt_patientName.Text)) ||
                (String.IsNullOrEmpty(txt_clinicalCost.Text)) ||
                (string.IsNullOrEmpty(txt_instrumentalCost.Text)) || (String.IsNullOrEmpty(txt_diagnosesCost.Text)) ||
                (String.IsNullOrEmpty(txt_cabinCost.Text)) || (String.IsNullOrEmpty(txt_treatmentCost.Text)) ||
                (String.IsNullOrEmpty(txt_advancePaid.Text)) || (String.IsNullOrEmpty(txt_discount.Text)) ||
                (String.IsNullOrEmpty(txt_due.Text)))
            {
                MessageBox.Show("Please insert a number value", "Missing Value", MessageBoxButtons.OK,
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please insert a Patient ID ", "Missing ID", MessageBoxButtons.OK,
                    MessageBoxIcon.Question);
            }
            else
            {
        ...
        {
            e.Graphics.DrawString("Payment & Delivery Receipt \n", new Font("Arial", 30, FontStyle.Bold), Brushes.Black, 80, 70);
            e.Graphics.DrawString("\nPatient ID- " + txt_patientId2.Text +
